# Licences des fonts self-hostées

Ce dossier contient les fichiers webfonts (`.woff2`) servis par le site. Aucune font n'est
chargée depuis un hôte externe. Les textes complets des licences couvrant ces fichiers sont
reproduits ci-dessous, copiés tels quels depuis les archives officielles de distribution.

| Famille | Graisses | Source | Licence |
|---|---|---|---|
...
## ITF Free Font License (FFL) — Clash Display, Switzer

Licence distribuée par l'Indian Type Foundry via Fontshare sous le nom « ITF Free Font
License » (fichier `License/FFL.txt` des archives officielles Clash Display et Switzer,
identique dans les deux). Texte complet :
...
## SIL Open Font License 1.1 (OFL) — JetBrains Mono

Copyright 2020 The JetBrains Mono Project Authors (https://github.com/JetBrains/JetBrainsMono).
Fichier `OFL.txt` de l'archive officielle JetBrainsMono-2.304.zip. Texte complet :
